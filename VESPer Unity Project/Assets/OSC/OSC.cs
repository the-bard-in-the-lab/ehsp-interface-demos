/*   This script is adapted from https://t-o-f.info/UnityOSC/

Please note that this project is no longer maintained. There are
other libraries available that accomplish the same thing. If you
are doing work with OSC and Unity, I suggest making use of one
of those.   */
