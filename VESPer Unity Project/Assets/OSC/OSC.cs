/*
This script is based on https://github.com/thomasfredericks/UnityOSC by Thomas O. Fredericks

Please note that the original project is no longer maintained. There are other libraries
available that accomplish the same thing. If you are doing work with OSC and Unity and want
a more robust set of tools from the start, you may want to look elsewhere. This has been
adapted for specific use with Sensory Percussion, which generally requires precise
timing.
*/
